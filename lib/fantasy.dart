...
class Fantasy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<FantasyBooks> fantasy = controller.getFantasyBooks();
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ImageWithText1('assets/troubled.png', 'Troubled Blood', '4.9'),
                ImageWithText1('assets/negeriparabedebah.png', 'Negeri Para Bedebah', '4.1'),
              ],
            ),
            Row(
              children: <Widget>[
                ImageWithText1('assets/lautbercerita.png', 'Laut Bercerita', '4.3'),
                ImageWithText1('assets/silkworm.png', 'Silkworm Thessis', '4.5'),
              ],
            ),
            Row(
              children: <Widget>[
                ImageWithText1('assets/olympus.png', 'Olympus Is Hero', '4.4'),
                ImageWithText1('assets/kingofdrugs.png', 'Drug King', '4.2'),
              ],
            ),
          ],
        ),
