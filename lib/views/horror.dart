...
import 'package:letterku/controller/horror_controller.dart';
import 'package:letterku/models//horror_model.dart';

class Horror extends StatelessWidget {
  final HorrorController controller = HorrorController();
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ImageWithText1('assets/risa.png', 'Risa Lapar', '4.9'),
                ImageWithText1('assets/curseinfinity.png', 'Infinity Scream', '4.1'),
              ],
            ),
            Row(
              children: <Widget>[
                ImageWithText1('assets/carrerofevil.png', 'Evil Lads', '4.3'),
                ImageWithText1('assets/soul.png', 'Soul Reaper', '4.5'),
              ],
            ),
            Row(
              children: <Widget>[
